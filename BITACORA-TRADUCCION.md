...
- [ ] **Panel de usuario completo** (Perfil, Publicar, Mensajes, Configuración) — decidido que puede esperar.
- [ ] **Acortar el `PROMPT_BASE`** de la función Edge `chat-ia` (causa raíz del error 429 en el chat en general).
