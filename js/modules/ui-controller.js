    ...
    mostrarResultadosVideo: function(tema, videos, etiqueta) {
        ...
        if (!videos.length) {
            ...
            html += videos.map(function(v) {
                var miniatura = v.miniatura ? '<img src="' + v.miniatura + '" class="result-img" alt="' + v.titulo + '">' : '<div class="result-icon-fallback">' + etiqueta.icono + '</div>';
    ...
    mostrarResultadosWeb: function(tema, resultadosWeb) {
        ...
        if (!resultadosWeb.length) {
            ...
            html += resultadosWeb.map(function(w) {
                return '<div class="result-item" onclick="window.open(\'' + w.link + '\', \'_blank\')"><div class="result-icon-fallback">🌐</div><div class="result-info"><div class="result-title">' + w.titulo + '</div><div class="result-desc">' + (w.resumen || '') + '</div></div></div>';
            }).join('');
        }
        this.elementos.searchResultsContent.innerHTML = html;
    },
